...
public class UcBlockColors
{
    public static void setBlockColors(ColorHandlerEvent.Block event)
    {
        ...
        colors.register((state, level, pos, tint) ->
                ...
                BlockRegistration.COMPRESSED_ACACIA_LEAVES.get(), BlockRegistration.COMPRESSED_DARK_OAK_LEAVES.get(), BlockRegistration.COMPRESSED_JUNGLE_LEAVES.get(), BlockRegistration.COMPRESSED_OAK_LEAVES.get());
