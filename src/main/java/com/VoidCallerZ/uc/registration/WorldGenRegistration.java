...
public class WorldGenRegistration
{
    ...
    public static final RegistryObject<PlacedFeature> COMPRESSED_ANCIENT_DEBRIS_GEN = PLACED_FEATURES.register("compressed_ancient_debris", () -> Ores.createAncientDebrisOregen(BlockRegistration.COMPRESSED_ANCIENT_DEBRIS, 3, 2, 8, 119).get());
}