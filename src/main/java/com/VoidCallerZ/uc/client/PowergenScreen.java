...
{
    private final ResourceLocation GUI = new ResourceLocation(UltimateCompression.MODID, "textures/gui/powergen_gui.png");
    public PowergenScreen(PowergenContainer container, Inventory inv, Component name) { super(container, inv, name); }
