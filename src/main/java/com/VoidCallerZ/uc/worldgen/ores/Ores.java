...
public class Ores
{
    ...
    public static void registerConfiguredFeatures()
    {
        ...
        COAL_OREGEN = registerPlacedFeatureUniform("compressed_coal_ore", false, Registration.COMPRESSED_COAL_ORE.get().defaultBlockState(), OresConfig.OVERWORLD_COAL_VEINSIZE.get(), OresConfig.OVERWORLD_COAL_AMOUNT.get(), 136, 255);
