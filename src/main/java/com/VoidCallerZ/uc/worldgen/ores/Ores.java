...
public class Ores
{
    ...
    {
        OreConfiguration deepslateConfig = new OreConfiguration(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, Registration.COMPRESSED_DEEPSLATE_IRON_ORE.get().defaultBlockState(), OresConfig.DEEPSLATE_VEINSIZE.get());
    ...
    public static Holder<PlacedFeature> createOverworldOregen()
    {
        ...
        return registerPlacedFeature("overworld_iron_ore", new ConfiguredFeature<>(Feature.ORE, overworldConfig),
