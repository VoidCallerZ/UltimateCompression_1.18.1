...
public class Ores
{
    ...
    public static void registerConfiguredFeatures()
    {
        ...
        DIAMOND_OREGEN = registerPlacedFeatureUniform("compressed_diamond_ore", Registration.COMPRESSED_DIAMOND_ORE.get().defaultBlockState(), OresConfig.OVERWORLD_VEINSIZE.get(), OresConfig.OVERWORLD_AMOUNT.get(), 0, 16);
        ...
        EMERALD_OREGEN = registerPlacedFeatureTriangle("compressed_emerald_ore", Registration.COMPRESSED_EMERALD_ORE.get().defaultBlockState(), OresConfig.OVERWORLD_VEINSIZE.get(), OresConfig.OVERWORLD_AMOUNT.get(), 0, 255);
