...
public class ucBlockStates extends BaseBlockStateProvider
{
    ...
    protected void registerStatesAndModels()
    {
        ...
        //Leaves
        singleTextureBlockWithBlockColors(BlockRegistration.COMPRESSED_ACACIA_LEAVES.get(), "compressed_acacia_leaves", "block/compressed/leaves/compressed_acacia_leaves");
        singleTextureBlockWithBlockColors(BlockRegistration.COMPRESSED_BIRCH_LEAVES.get(), "compressed_birch_leaves", "block/compressed/leaves/compressed_birch_leaves");
        singleTextureBlockWithBlockColors(BlockRegistration.COMPRESSED_DARK_OAK_LEAVES.get(), "compressed_dark_oak_leaves", "block/compressed/leaves/compressed_dark_oak_leaves");
        singleTextureBlockWithBlockColors(BlockRegistration.COMPRESSED_JUNGLE_LEAVES.get(), "compressed_jungle_leaves", "block/compressed/leaves/compressed_jungle_leaves");
        singleTextureBlockWithBlockColors(BlockRegistration.COMPRESSED_OAK_LEAVES.get(), "compressed_oak_leaves", "block/compressed/leaves/compressed_oak_leaves");
        singleTextureBlockWithBlockColors(BlockRegistration.COMPRESSED_SPRUCE_LEAVES.get(), "compressed_spruce_leaves", "block/compressed/leaves/compressed_spruce_leaves");
        ...
        //Glass Blocks
        singleTextureBlock(BlockRegistration.COMPRESSED_GLASS.get(), "compressed_glass", "block/compressed/glass/compressed_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_BLACK_STAINED_GLASS.get(), "compressed_black_stained_glass", "block/compressed/glass/compressed_black_stained_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_BLUE_STAINED_GLASS.get(), "compressed_blue_stained_glass", "block/compressed/glass/compressed_blue_stained_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_BROWN_STAINED_GLASS.get(), "compressed_brown_stained_glass", "block/compressed/glass/compressed_brown_stained_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_CYAN_STAINED_GLASS.get(), "compressed_cyan_stained_glass", "block/compressed/glass/compressed_cyan_stained_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_GRAY_STAINED_GLASS.get(), "compressed_gray_stained_glass", "block/compressed/glass/compressed_gray_stained_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_GREEN_STAINED_GLASS.get(), "compressed_green_stained_glass", "block/compressed/glass/compressed_green_stained_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_LIGHT_BLUE_STAINED_GLASS.get(), "compressed_light_blue_stained_glass", "block/compressed/glass/compressed_light_blue_stained_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_LIGHT_GRAY_STAINED_GLASS.get(), "compressed_light_gray_stained_glass", "block/compressed/glass/compressed_light_gray_stained_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_LIME_STAINED_GLASS.get(), "compressed_lime_stained_glass", "block/compressed/glass/compressed_lime_stained_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_MAGENTA_STAINED_GLASS.get(), "compressed_magenta_stained_glass", "block/compressed/glass/compressed_magenta_stained_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_ORANGE_STAINED_GLASS.get(), "compressed_orange_stained_glass", "block/compressed/glass/compressed_orange_stained_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_PINK_STAINED_GLASS.get(), "compressed_pink_stained_glass", "block/compressed/glass/compressed_pink_stained_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_PURPLE_STAINED_GLASS.get(), "compressed_purple_stained_glass", "block/compressed/glass/compressed_purple_stained_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_RED_STAINED_GLASS.get(), "compressed_red_stained_glass", "block/compressed/glass/compressed_red_stained_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_WHITE_STAINED_GLASS.get(), "compressed_white_stained_glass", "block/compressed/glass/compressed_white_stained_glass");
        singleTextureBlock(BlockRegistration.COMPRESSED_YELLOW_STAINED_GLASS.get(), "compressed_yellow_stained_glass", "block/compressed/glass/compressed_yellow_stained_glass");

        //Glass Panes
        paneBlock(BlockRegistration.COMPRESSED_GLASS_PANE.get(), "compressed_glass_pane", "block/compressed/glass/compressed_glass");
        paneBlock(BlockRegistration.COMPRESSED_BLACK_STAINED_GLASS_PANE.get(), "compressed_black_stained_glass_pane", "block/compressed/glass/compressed_black_stained_glass");
        paneBlock(BlockRegistration.COMPRESSED_BLUE_STAINED_GLASS_PANE.get(), "compressed_blue_stained_glass_pane", "block/compressed/glass/compressed_blue_stained_glass");
        paneBlock(BlockRegistration.COMPRESSED_BROWN_STAINED_GLASS_PANE.get(), "compressed_brown_stained_glass_pane", "block/compressed/glass/compressed_brown_stained_glass");
        paneBlock(BlockRegistration.COMPRESSED_CYAN_STAINED_GLASS_PANE.get(), "compressed_cyan_stained_glass_pane", "block/compressed/glass/compressed_cyan_stained_glass");
        paneBlock(BlockRegistration.COMPRESSED_GRAY_STAINED_GLASS_PANE.get(), "compressed_gray_stained_glass_pane", "block/compressed/glass/compressed_gray_stained_glass");
        paneBlock(BlockRegistration.COMPRESSED_GREEN_STAINED_GLASS_PANE.get(), "compressed_green_stained_glass_pane", "block/compressed/glass/compressed_green_stained_glass");
        paneBlock(BlockRegistration.COMPRESSED_LIGHT_BLUE_STAINED_GLASS_PANE.get(), "compressed_light_blue_stained_glass_pane", "block/compressed/glass/compressed_light_blue_stained_glass");
        paneBlock(BlockRegistration.COMPRESSED_LIGHT_GRAY_STAINED_GLASS_PANE.get(), "compressed_light_gray_stained_glass_pane", "block/compressed/glass/compressed_light_gray_stained_glass");
        paneBlock(BlockRegistration.COMPRESSED_LIME_STAINED_GLASS_PANE.get(), "compressed_lime_stained_glass_pane", "block/compressed/glass/compressed_lime_stained_glass");
        paneBlock(BlockRegistration.COMPRESSED_MAGENTA_STAINED_GLASS_PANE.get(), "compressed_magenta_stained_glass_pane", "block/compressed/glass/compressed_magenta_stained_glass");
        paneBlock(BlockRegistration.COMPRESSED_ORANGE_STAINED_GLASS_PANE.get(), "compressed_orange_stained_glass_pane", "block/compressed/glass/compressed_orange_stained_glass");
        paneBlock(BlockRegistration.COMPRESSED_PINK_STAINED_GLASS_PANE.get(), "compressed_pink_stained_glass_pane", "block/compressed/glass/compressed_pink_stained_glass");
        paneBlock(BlockRegistration.COMPRESSED_PURPLE_STAINED_GLASS_PANE.get(), "compressed_purple_stained_glass_pane", "block/compressed/glass/compressed_purple_stained_glass");
        paneBlock(BlockRegistration.COMPRESSED_RED_STAINED_GLASS_PANE.get(), "compressed_red_stained_glass_pane", "block/compressed/glass/compressed_red_stained_glass");
        paneBlock(BlockRegistration.COMPRESSED_WHITE_STAINED_GLASS_PANE.get(), "compressed_white_stained_glass_pane", "block/compressed/glass/compressed_white_stained_glass");
        paneBlock(BlockRegistration.COMPRESSED_YELLOW_STAINED_GLASS_PANE.get(), "compressed_yellow_stained_glass_pane", "block/compressed/glass/compressed_yellow_stained_glass");
