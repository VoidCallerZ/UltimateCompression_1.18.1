...
public class ucDutchLanguageProvider extends LanguageProvider
{
    ...
    protected void addTranslations()
    {
        ...
        add(BlockRegistration.COMPRESSED_MANGROVE_LOG.get(), "Samengeperste Mangrovestam");
        add(BlockRegistration.COMPRESSED_MANGROVE_PLANKS.get(), "Samengeperste Mangrovehouten Planken");
        add(BlockRegistration.COMPRESSED_MANGROVE_ROOTS.get(), "Samengeperste Mangrovewortels");
        ...
        add(BlockRegistration.COMPRESSED_POWDER_SNOW.get(), "Samengeperste Poedersneeuw");

        //Sculk Blocks
        add(BlockRegistration.COMPRESSED_SCULK.get(), "Samengeperst Sculk");
        add(BlockRegistration.COMPRESSED_SCULK_CATALYST.get(), "Samengeperste Sculkkatalysator");
        ...
        add(ItemRegistration.COMPRESSED_POWDER_SNOW_BUCKET.get(), "Samengeperste Emmer Poedersneeuw");
