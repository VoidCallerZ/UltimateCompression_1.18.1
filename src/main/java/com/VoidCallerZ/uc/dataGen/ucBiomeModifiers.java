...
public class ucBiomeModifiers implements DataProvider
{
    ...
    public void run(CachedOutput cache)
    {
        ...
        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_IRON_ORE_GEN);
        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_GOLD_ORE_GEN);
        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_COPPER_ORE_GEN);
        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_DIAMOND_ORE_GEN);
        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_COAL_ORE_GEN);
        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_EMERALD_ORE_GEN);
        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_LAPIS_ORE_GEN);
        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_REDSTONE_ORE_GEN);

        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_DEEPSLATE_IRON_ORE_GEN);
        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_DEEPSLATE_GOLD_ORE_GEN);
        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_DEEPSLATE_COPPER_ORE_GEN);
        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_DEEPSLATE_DIAMOND_ORE_GEN);
        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_DEEPSLATE_COAL_ORE_GEN);
        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_DEEPSLATE_EMERALD_ORE_GEN);
        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_DEEPSLATE_LAPIS_ORE_GEN);
        customEncoder(cache, ops, WorldGenRegistration.COMPRESSED_DEEPSLATE_REDSTONE_ORE_GEN);
    }
    ...
    private void customEncoder(CachedOutput cache, RegistryOps<JsonElement> ops, RegistryObject<PlacedFeature> oreFeature)
    {
        ...
        BiomeModifier.DIRECT_CODEC.encodeStart(ops, biomeModifier_)
