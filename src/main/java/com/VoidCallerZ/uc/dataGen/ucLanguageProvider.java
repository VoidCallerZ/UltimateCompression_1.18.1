...
public class ucLanguageProvider extends LanguageProvider
{
    ...
    protected void addTranslations()
    {
        ...
        //Default
        add(ArmorRegistration.COMPRESSED_LEATHER_HELMET.get(), "Compressed Leather Helmet");
        add(ArmorRegistration.COMPRESSED_LEATHER_CHESTPLATE.get(), "Compressed Leather Chestplate");
        add(ArmorRegistration.COMPRESSED_LEATHER_LEGGINGS.get(), "Compressed Leather Leggings");
        add(ArmorRegistration.COMPRESSED_LEATHER_BOOTS.get(), "Compressed Leather Boots");
